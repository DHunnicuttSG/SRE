...
flowchart TD
    ...
    style B fill=#f3c,stroke=#fe2,stroke-width=2px
    style C fill=#cef,stroke=#0bf,stroke-width=2px
    style D fill=#dda,stroke=#875,stroke-width=2px
    style E fill=#eee,stroke=#677,stroke-width=1px
```
---
