Got it 👍 — here’s a structured course section explaining those file management commands, with syntax, examples, and key notes.
...
Great — here’s a **practice exercise set with answers** for the file management commands (`touch`, `rm`, `mkdir`, `rmdir`, `mv`, `cp`).
