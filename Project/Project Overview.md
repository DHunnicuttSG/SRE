...
The final project will consist of three parts.  Part one will be to create a full-stack application using python. The second part will be to deploy the application using an automated process. Part three will be a 10 minute presentation on your app and your process.  
...
* The frontend can be written using anylanguage you like, React, Angular, JS, Flask/Django templates are fine too.
...
* I encourage you to explore different options such as, Docker, Github, Heroku, AWS CodeDeploy.
...
* Be able to run your app locally before you deploy